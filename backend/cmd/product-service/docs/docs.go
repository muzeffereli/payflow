...
const docTemplate = `{
    ...
    "securityDefinitions": {
        "BearerAuth": {
            "description": "JWT access token issued by the API Gateway",
            "type": "apiKey",
            "name": "Authorization",
            "in": "header"
        }
...
var SwaggerInfo = &swag.Spec{
	...
	Description:      "Manages the product catalog with authoritative prices and stock levels. Orders must fetch prices from here â€” clients cannot set prices.",
