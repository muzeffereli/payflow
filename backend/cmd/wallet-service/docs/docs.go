...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/payments/{id}": {
            "get": {
                ...
                "description": "Returns payment status and details.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.GatewayPayment"
                        }
                    },
                    "404": {
                        "description": "Not Found",
    ...
    "securityDefinitions": {
        "BearerAuth": {
            "description": "JWT token issued by the API Gateway (omit \"Bearer \" prefix inside service)",
            "type": "apiKey",
            "name": "Authorization",
            "in": "header"
        }
...
var SwaggerInfo = &swag.Spec{
	...
	Description:      "Manages user wallet balances and processes refund credits via NATS events.",
